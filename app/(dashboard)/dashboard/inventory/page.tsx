...
const config = {
  ...
  actions: [{ label: 'Quick restock +1', tone: 'secondary', onClick: (item) => adminApi.adjustInventory(item.id, { movement_type: 'IN', quantity: 1, note: 'Quick restock from web admin dashboard' }) }],
  readOnly: false,
